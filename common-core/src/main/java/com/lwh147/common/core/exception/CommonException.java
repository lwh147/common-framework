...
public class CommonException extends RuntimeException implements ICommonException {
     ...
     **/
    public CommonException(String code, String message, String causation) {
    ...
    /**
     * 使用异常枚举类行为规范接口对象的构造方式2
     * 带错误原因
     *
     * @param ice 异常枚举类行为规范接口对象
     * @param e   错误原因，导致出错的未知异常
     **/
    public CommonException(ICommonExceptionEnum ice, Throwable e) {
     ...
     * 转String字符串模板
     **/
    private static final String MESSAGE_PATTERN = "CommonException(code: {0}, message: {1}, causation: {2})";
}
